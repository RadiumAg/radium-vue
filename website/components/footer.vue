  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a
          href="https://github.com/radium-vue/radium-vue"
        ...
        <a
          href="https://github.com/radium-vue/radium-vue-starter"
          class="footer-main-link"
          target="_blank"
      ...
      <div class="footer-main">
        ...
        <a
          href="https://github.com/radium-vue/radium-vue/issues"
          class="footer-main-link"
          target="_blank"
        >{{ langConfig.feedback }}</a>
        <a
          :href="
            `https://github.com/radium-vue/radium-vue/blob/dev/.github/CONTRIBUTING.${lang}.md`
          "
          class="footer-main-link"
          target="_blank"
        >{{ langConfig.contribution }}</a>
        <a
          href="https://segmentfault.com/t/radium-vue"
          class="footer-main-link"
          target="_blank"
        >SegmentFault</a>
      </div>

<template>
  <div>
    ...
    <ul>
      <li>
        <strong>{{ langConfig[11] }}</strong>{{ langConfig[12] }}
      </li>
      <li>
        <strong>{{ langConfig[13] }}</strong>{{ langConfig[14] }}
      </li>
    </ul>
    <h3>{{ langConfig[15] }}</h3>
    <ul>
      <li>
        <strong>{{ langConfig[16] }}</strong>{{ langConfig[17] }}
      </li>
      <li>
        <strong>{{ langConfig[18] }}</strong>{{ langConfig[19] }}
      </li>
    </ul>
    <h3>{{ langConfig[20] }}</h3>
    <ul>
      <li>
        <strong>{{ langConfig[21] }}</strong>{{ langConfig[22] }}
      </li>
      <li>
        <strong>{{ langConfig[23] }}</strong>{{ langConfig[24] }}
      </li>
      <li>
        <strong>{{ langConfig[25] }}</strong>{{ langConfig[26] }}
      </li>
    </ul>
    <h3>{{ langConfig[27] }}</h3>
    <ul>
      <li>
        <strong>{{ langConfig[28] }}</strong>{{ langConfig[29] }}
      </li>
      <li>
        <strong>{{ langConfig[30] }}</strong>{{ langConfig[31] }}
      </li>
    </ul>
  </div>
</template>
